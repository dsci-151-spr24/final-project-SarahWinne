...
```{r echo=FALSE}
data <- read_csv("/cloud/project/data/ProjectGutenbergMetadata.csv", show_col_types = FALSE)
```
...
I will be comparing by decade, then comparing ages to each other, and also the type of book written.
